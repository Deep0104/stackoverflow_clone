<%-- 
    Document   : login
    Created on : 20 Aug, 2020, 2:45:02 PM
    Author     : dprisky
--%>
...
<head>
    ...
    <title>Stackoverflow-Admin Panel</title>
    <!-- Bootstrap Styles-->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i>Sign In</a>
                        </li>
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i>Sign Up</a>
                        </li>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Login <small>Welcome User</small>
                        </h1>
						<ol class="breadcrumb">
