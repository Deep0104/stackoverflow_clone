<%-- 
    Document   : home.jsp
    Created on : 9 Sep, 2020, 6:42:50 PM
    Author     : dprisky
--%>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <button class="btn btn-success" style="float:left;border:none">Create an Account</button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="navbar-header">
                        ...
                        <a href="#" class="navbar-brand"><strong>StackOverflow</strong></a>
                    </div>
                    ...
                    <div class="navbar-collapse collapse" id="mobile_menu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><button onclick="pageRedirect()" class="btn btn-primary" style="margin-top:5px"><i class="glyphicon glyphicon-log-out"></i></button></li>
        ...
        <%
         ...
         %>
            ...
            <div class="col-sm-3  w3-padding-32">
                ...
                <h1>Ask Your Questions</h1>
                    <form method="post" action="user_question.jsp">
                        ...
                        <textarea class="form-control" cols="12" rows="8"></textarea><br>
				...
				<form method="post"  action="feedback.jsp"  >
		  		...
		  		<div class="col-sm-6 w3-container w3-padding-32" >
					<center><h2 style="color:black;font-family:'Comic Sans MS'">STACKOVERFLOW</h2>
		  ...
		  <div class="row" style="background-color:#000000">
		  		<div class="col-sm-12" style="height:50px"><br><center><a href="#" style="color:#FFFFFF">Deepak @STACKOVERFLOW  ©  2020</a></center>
		</div>
                  </div>
                      </div>
	<!-- end footer -->  
