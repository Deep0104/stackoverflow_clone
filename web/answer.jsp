<%-- 
    Document   : answer
    Created on : 10 Sep, 2020, 10:46:23 PM
    Author     : dprisky
--%>
    ...
    <head>
        ...
        <script>
            ...
            function generatenew(){
                document.answer.ans.style.visibility="visible";
                 document.answer.sub.style.visibility="visible";
            }
               ...
               <div class="row">
                    ...
                    <table class="table table-responsive w3-card">
                        ...
                        <tr>
                            ...
                            <td style="border:none" align="right"><button class="button2">Active</button><button class="button2">Hot</button><button class="button2">Week</button><button class="button2">Month</button></td>
                        </tr>
                    </table>
    ...
    <%
        String pg=request.getParameter("pg");
            ...
            try{
                ...
                ResultSet rs=st.executeQuery("select * from trends where qcode='"+id+"'");
                while(rs.next()){
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h1> Question:- <%=rs.getString("question")%></h1>
                        </div>
                        <div class="panel-body">
                            Answer:- <label><%=rs.getString("answer")%></label><br><br>       
                            <form name='answer' method="post" action="add_ans.jsp?id=<%=rs.getString("qcode")%>">
                              <div id="div"></div>
                              <input type="button" class="btn btn-info" value="Give Answer" onclick="generatenew();"> <br><br> 
                              <textarea  style="visibility:hidden" required rows="3" cols="45" name="ans"></textarea><br>
                              <input type="submit" style="visibility:hidden" name="sub"   value="submit">  
                            </form><br>
                            <div class="form-group">
                                <button style="float:right" class="dislike">
                                    <i class="fa fa-thumbs-o-down" aria-hidden="true"></i>
                            </button>
                                &nbsp;&nbsp;&nbsp;
                            <button style="float:right" class="like">
